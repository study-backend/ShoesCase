 ...
 * 
 * import shop.shoes.dao.PurchaseDAO; import shop.shoes.dao.PurchaseDAOImpl;
 * import shop.shoes.model.GoodsDTO; import shop.shoes.model.PurchaseBasketDTO;
 * import shop.shoes.model.PurchaseBasketPaymentDTO; import
 * shop.shoes.model.PurchaseGoodsDTO;
 * 
 * public class PurchaseServiceImpl implements PurchaseService { // 필요한 dAO
 * 목록.....
 * 
 * @Override public int insertPurchase(List<GoodsDTO> goodsList,
 * PurchaseBasketDTO basket, PurchaseBasketPaymentDTO payment) {
 * 
 * // 구매 알고리즘
 * 
 * //[0] 빌키 받아오기
 ...
 * return 0; }
 * 
 * public List<PurchaseGoodsDTO> selectOrderHistory(long accountId) throws
 * SQLException{ PurchaseDAO purchaseDAO = new PurchaseDAOImpl();
