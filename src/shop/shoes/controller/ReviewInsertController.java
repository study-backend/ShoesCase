 ...
 * 
 * import shop.shoes.model.ReviewDTO; import shop.shoes.service.ReviewService;
 * 
 ...
 * 
 * 예상 되는 값 : 제목 내용 만족도 String title = request.getParameter("네임값"); String
 * content = request.getPrameter("네임값"); String score =
 * request.getPrameter("네임값");
 * 
 * 
 * 
 * 
