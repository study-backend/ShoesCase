...
insert into goods values(4,50000,'나이키에어맥스',30,'#이미지path','#섬네일path',0,0,'시리얼넘버0001', 2,1,1,1,sysdate,sysdate);
insert into goods values(5,50000,'fila운동화',20,'#이미지path','#섬네일path',0,0,'시리얼넘버0002', 2,1,1,1,sysdate,sysdate);
insert into goods values(6,50000,'아디다스운동화',40,'#이미지path','#섬네일path',0,0,'시리얼넘버0003', 2,1,1,1,sysdate,sysdate);
insert into goods values(7,50000,'나이키에어맥스',30,'#이미지path','#섬네일path',0,0,'시리얼넘버0001', 2,1,1,1,sysdate,sysdate);
insert into goods values(8,50000,'fila운동화',20,'#이미지path','#섬네일path',0,0,'시리얼넘버0002', 3,1,1,1,sysdate,sysdate);
insert into goods values(9,50000,'아디다스운동화',40,'#이미지path','#섬네일path',0,0,'시리얼넘버0003', 3,1,1,1,sysdate,sysdate);
insert into goods values(10,50000,'나이키에어맥스',30,'#이미지path','#섬네일path',0,0,'시리얼넘버0001', 3,1,1,1,sysdate,sysdate);
insert into goods values(11,50000,'fila운동화',20,'#이미지path','#섬네일path',0,0,'시리얼넘버0002', 4,1,1,1,sysdate,sysdate);
insert into goods values(12,50000,'아디다스운동화',40,'#이미지path','#섬네일path',0,0,'시리얼넘버0003', 4,1,1,1,sysdate,sysdate);
select * from goods
