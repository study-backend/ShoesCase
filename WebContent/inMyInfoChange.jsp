        ...
        <div class="boardForm1" style="box-sizing: border-box; margin:110px 300px 70px 300px;">
            ...
            <div class="boardForm2" style="float:left; margin-left:45px;">
                ...
                <div class="boardWrite" style="margin-top: 30px">
                    <form method="post" action="/">
                        <table class="inForm" style="margin: auto;">
                            <tbody>
                            <tr>
                                <td class="memberCols1" width="140">
                                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp아이디*
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="memberCols2">
                                    <input type="password" name="pwdOk" option="regPass"
                            ...
                            <tr>
                                ...
                                <td class="memberCols2">
                                    <input type="text" name="email" size="30" option="regEmail"
                            ...
                            <tr>
                                ...
                                <td class="memberCols2">
                                    <div style="margin-top: 11px; margin-left: 36px;">
                                        <input type="text" placeholder="주소 검색" style="margin-bottom: 5px;"
                                               name="address_sub">
                                    </div>
                                    <div>
                                ...
                                <td class="memberCols2">
                                    <div class="group_radio">
                                        <label class="label_radio">
                                            <input type="radio" name="maleFemale" label="성별" value="m"
                            ...
                            <tr class="birth field_birth">
                                ...
                                <td class="memberCols2">
                                    <div class="birth_day">
                                        <input type="text" name="birthYear" pattern="[0-9]*" value="" label="생년월일"
                                               size="5"
                                               maxlength="4" placeholder="YYYY"
                                               style="margin-top: 14px; margin-left: 36px;">
                                        <span class="bar"><span>/</span></span>
                                        <input type="text" name="birthMonth" id="birthMonth" pattern="[0-9]*"
                                               label="생년월일" size="3"
                                               maxlength="2" placeholder="MM">
                                        <span class="bar"><span>/</span></span>
                                        <input type="text" name="birthDay" id="birthDay" pattern="[0-9]*" label="생년월일"
                                               size="3"
                ...
                <div style="text-align: center;">
                    ...
                    <button type="submit" class="m_button" id="check" href.location="inMyInfoChange.jsp"><span>확인</span>
                    </button>
                    </form>
                </div>
            </div>
            ...
            <tr>
                <td>
                    <div class="f">
                        ...
                        <address class="copyright mt10">COPYRIGHT © SHOES-CASE KOREA CO,LTD. ALL RIGHTS RESERVED.
                        </address>
                    </div>
                </td>
                ...
                <td>
                    <div class="s">
                        ...
                        <p class="mt15">운영시간 : 월~금 09:00 ~18:00 (12:00 ~13:00 점심시간)<br><em style="margin-left:55px;">주말,
                            공휴일 휴무</em><br>
                            이메일 : <a href="mailto:abcmartcs@abcmartkorea.com">shoesCase@scmartkorea.com</a></p>
                        <ul class="clearfix">
                            <li><img src="http://image.abcmart.co.kr/nexti/images/abcmart_new/confirm_01.gif" alt="">
                            </li>
                            <li><img src="http://image.abcmart.co.kr/nexti/images/abcmart_new/confirm_02.gif"
                                     alt=""></a></li>
                        </ul>
                    </div>
                </td>
